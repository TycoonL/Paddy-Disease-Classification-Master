...
wandb.init(project="my-test-project",name='wandb-1')
wandb.config.update({
...
model_pth = './weight/'+model_name+'_wandb_model.pth'
...
submission_output = './Paddy Doctor Dataset/submission_'+model_name+'_wandb.csv'
